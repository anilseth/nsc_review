...
g16['logsigmae']=np.log10(g16['MNSC']*1e4/(3.1415*g16['reffNSC']**2))
...
n14['logsigmae']=np.log10(n14['M_']/(3.1415*n14['Re']**2))

n14gal=(n14['Type'] != 3)
n14co=np.where((n14['Type'] != 3))# & (n14['Type'] < 7))


e12['logsigmae']=np.log10(10**(e12['logmnuc'])/(3.1415*e12['reff']**2))
acsvcs['logsigmae']=np.log10(10**(acsvcs['logmstarnuc'])/(3.1415*(acsvcs['r_hg']*80.)**2))
...
e12lateind=(e12['T'] > 1)
h3=plt.scatter(e12['logmnuc'][e12lateind],np.log10(e12['reff'][e12lateind]),color='b',alpha=0.5,marker="*",s=200)
plt.legend(labels=['Late-Type','Early-Type','Good Mass'],handles=[h1,h2,h3],fontsize=ufontsize/1.2,loc=2)
plt.scatter(e12['logmnuc'][e12earlyind],np.log10(e12['reff'][e12earlyind]),color='r',alpha=0.5,marker="*",s=200)
#plt.legend(labels=['Late-type','Early-type','Good Mass','GCs/UCDs/cEs'],handles=[h1,h2,h3,h4])
plt.xlim(4.5,12)
plt.ylim(-0.4,5)
